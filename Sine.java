...
public class Sine extends JPanel {
    public void paintComponent(Graphics g){
        ...
        while(x < 6.1) {
            ...
            y2 = y1;
            x += delta;
            y = Math.sin(x); //keep this positive if you want a grade
            x1 = (int)(6 + x * 100);
            y1 = (int)(300 + y * 100);
    ...
    public static void main(String[] args) {
        ...
        if(a == 0){
            ...
            double value = Math.sin(Math.toRadians(x));
            JOptionPane.showMessageDialog(null,"The sine of " + s + " is " + value);
        }else if(a == 2){
            JOptionPane.showMessageDialog(null,"Domain of sine is all real numbers");
        }else if(a == 3){
            JOptionPane.showMessageDialog(null,"Range of sine is -1 to 1");
        }
    }
}
