...
public class GreatestIntegerFunction extends JPanel {
    public void paintComponent(Graphics g) {
        ...
        g.drawString("Greatest Integer Function", 400, 50);
    ...
    public static void main(String[] args) {
        ...
        if(a == 0){
            ...
            JOptionPane.showMessageDialog(null,"The greatest integer function of " + s + " is " + value);
        }else if(a == 2){
