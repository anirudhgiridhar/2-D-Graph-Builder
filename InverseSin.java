...
public class InverseSin extends JPanel {
    public void paintComponent(Graphics g){
        ...
        g.drawString("INVERSE SINE X", 400, 50);
        ...
        while(y < 6.1) {
            ...
            y2 = y1;
            y += delta;
            x = Math.sin(y); //keep this positive if you want a grade
            x1 = (int)(300 + x * 100);
            y1 = (int)(6 + y * 100);
    ...
    public static void main(String[] args) {
        ...
        if(a == 0){
            ...
            double value = Math.asin((x));
            JOptionPane.showMessageDialog(null,"The arc sine of " + s + " is " + String.format("%.2f",Math.toDegrees(value)));
        }else if(a == 2){
            JOptionPane.showMessageDialog(null,"Domain of arcsine is -1 to 1");
        }else if(a == 3){
            JOptionPane.showMessageDialog(null,"Range of arcsin is all real numbers");
        }
    }
}
